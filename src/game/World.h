...
enum Rates
{
    ...
    RATE_CREATURE_AND_GAMEOBJECT_RESPAWN,
    RATE_CORPSE_DECAY_LOOTED,
    RATE_CREATURE_NORMAL_DAMAGE_MIN,
    RATE_CREATURE_ELITE_ELITE_DAMAGE_MIN,
    RATE_CREATURE_ELITE_RAREELITE_DAMAGE_MIN,
    RATE_CREATURE_ELITE_WORLDBOSS_DAMAGE_MIN,
    RATE_CREATURE_ELITE_RARE_DAMAGE_MIN,
    RATE_CREATURE_NORMAL_DAMAGE_MAX,
    RATE_CREATURE_ELITE_ELITE_DAMAGE_MAX,
    RATE_CREATURE_ELITE_RAREELITE_DAMAGE_MAX,
    RATE_CREATURE_ELITE_WORLDBOSS_DAMAGE_MAX,
    RATE_CREATURE_ELITE_RARE_DAMAGE_MAX,
