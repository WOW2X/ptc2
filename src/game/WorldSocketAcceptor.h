...
#ifndef HELLGROUND_WORLDSOCKETACCEPTOR_H_
#define HELLGROUND_WORLDSOCKETACCEPTOR_H_
...
protected:
    ...
    virtual int handle_accept_error(void)
    {
        ...
        {
			sLog.outLog(LOG_DEFAULT, "Out of file descriptors, suspending incoming connections for 10 seconds");
