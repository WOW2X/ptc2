...
void World::LoadConfigSettings(bool reload)
{
    ...
    loadConfig(RATE_CREATURE_NORMAL_DAMAGE_MIN, "Rate.Creature.Normal.Damage.Min", 1.0f);
    loadConfig(RATE_CREATURE_ELITE_ELITE_DAMAGE_MIN, "Rate.Creature.Elite.Elite.Damage.Min", 1.0f);
    loadConfig(RATE_CREATURE_ELITE_RAREELITE_DAMAGE_MIN, "Rate.Creature.Elite.RAREELITE.Damage.Min", 1.0f);
    loadConfig(RATE_CREATURE_ELITE_WORLDBOSS_DAMAGE_MIN, "Rate.Creature.Elite.WORLDBOSS.Damage.Min", 1.0f);
    loadConfig(RATE_CREATURE_ELITE_RARE_DAMAGE_MIN, "Rate.Creature.Elite.RARE.Damage.Min", 1.0f);
    loadConfig(RATE_CREATURE_NORMAL_DAMAGE_MAX, "Rate.Creature.Normal.Damage.Max", 1.0f);
    loadConfig(RATE_CREATURE_ELITE_ELITE_DAMAGE_MAX, "Rate.Creature.Elite.Elite.Damage.Max", 1.0f);
    loadConfig(RATE_CREATURE_ELITE_RAREELITE_DAMAGE_MAX, "Rate.Creature.Elite.RAREELITE.Damage.Max", 1.0f);
    loadConfig(RATE_CREATURE_ELITE_WORLDBOSS_DAMAGE_MAX, "Rate.Creature.Elite.WORLDBOSS.Damage.Max", 1.0f);
    loadConfig(RATE_CREATURE_ELITE_RARE_DAMAGE_MAX, "Rate.Creature.Elite.RARE.Damage.Max", 1.0f);
